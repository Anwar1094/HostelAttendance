...
function loadWin() {
    ...
    window.onload = fetchStuAttendance()
...
async function Personal_Details() {
    ...
    //     return new Intl.DateTimeFormat('en-CA').format(date); // Returns YYYY-MM-DD format
    // }
...
function saveStuData() {
    // [stuId, Course,Year,Gender,Fathers_Name,Mothers_Name,Date_of_Joining,Student_Mobile_Number,Fathers_Mobile_Number,Address,City,State,Country,Postal_Code,Room_Type]
    // const stuId = (document.getElementById('Student_ID').value == '') ? null: document.getElementById('Student_ID')
    // const Course = (document.getElementById('Course').value == '') ? null: document.getElementById('Course')
    // const Year = (document.getElementById('Year').value == '') ? null: document.getElementById('Year')
    // let Gender = (document.getElementById('Gender').value == '') ? null: document.getElementById('Gender')
    // const Fathers_Name = (document.getElementById('Fathers_Name').value == '') ? null: document.getElementById('Fathers_Name')
    // const Mothers_Name = (document.getElementById('Mothers_Name').value == '') ? null: document.getElementById('Mothers_Name')
    // const Date_of_Joining = (document.getElementById('Date_of_Joining').value == '') ? null: document.getElementById('Date_of_Joining')
    // const Student_Mobile_Number = (document.getElementById('Student_Mobile_Number').value == '') ? null: document.getElementById('Student_Mobile_Number')
    // const Fathers_Mobile_Number = (document.getElementById('Fathers_Mobile_Number').value == '') ? null: document.getElementById('Fathers_Mobile_Number')
    // const Address = (document.getElementById('Address').value == '') ? null: document.getElementById('Address')
    // const City = (document.getElementById('City').value == '') ? null: document.getElementById('City')
    // let Country = (document.getElementById('Country').value == '') ? null: document.getElementById('Country')
    // let State = (document.getElementById('State').value == '') ? null: document.getElementById('State')
    // const Postal_Code = (document.getElementById('Postal_Code').value == '') ? null: document.getElementById('Postal_Code')
    // const Room_Type = (document.getElementById('Room_Type').value == '') ? null: document.getElementById('Room_Type')
    const data = []
    document.querySelectorAll('.inp').forEach(element => {
        if (element.id != 'Student_ID') {
            (element.value != '') ? data.push(element.value) : data.push(null);
        }
    })
    console.log(data)
...
function showAttendance() {
    ...
    if (startDate == '') {
        swal("Start Date Empyt!", `Please Set Start Date`, 'error')
        return
    } 
    if (endDate == '') {
        swal("End Date Empyt!", `Please Set End Date`, 'error')
        return
    } 
...
async function submitComplain() {
    ...
    document.querySelectorAll('.complain-inp').forEach(inp => {
        if (inp.value == ''&& inp.id != 'uploadDoc') {
            swal(`${inp.id.toUpperCase()} Can not be Empty`, `Please Enter ${inp.id.toUpperCase()}`, 'error')
            return
        }
        console.log(inp.value)
        complainData.push(inp.value)
    })
    ...
    try { 
        ...
        complainData.pop()
        formData.append('complainData', complainData)
